...
$(document).ready(function () {
                    ...
                    success: function (response) {
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                colect_last = collect_dis
                                alternatifs = alternatif
                                $("#btn-normalisasi").after(`<button class="btn btn-primary ml-2" id="btn-lanjut">Lanjutkan</button>`)
                                $("#spinner").html("")
                            }
                        });
                    }
    ...
    $(".card-footer").on("click", "#btn-lanjut", function () {
        $("#spinner").html(loader)
        $.ajax({
            data: { array: colect_last },
            url: "/matrix_dis",
            type: "GET",
            dataType: 'json',
            success: function (response) {
        ...
        <div class="col-sm-12">
            ...
            `
                ...
                let sum_c = (sum / (alternatifs * (alternatifs - 1))).toFixed(4);
                let sum_d = (sum2 / (alternatifs * (alternatifs - 1))).toFixed(4);
                let array_con = createMultiDimArray(con, alternatifs);
                let array_discon = createMultiDimArray(discon, alternatifs);
                ...
                // PERANGKINGAN
                let array_c = createMultiDimArray(c, alternatifs - 1)
                let array_d = createMultiDimArray(d, alternatifs - 1)
